	...
	{#if commandDone}
		<div in:fade={{ duration: 200 }}>
			<div class="mt-3 space-y-2">
				...
				<p class="text-term-subtext">Download ubicode from the App Store.</p>
			</div>
			<div class="mt-5">
				<a
					href="https://apps.apple.com/app/ubicode"
					target="_blank"
					rel="noopener noreferrer"
					class="inline-flex items-center gap-2 px-6 py-3 rounded-lg bg-term-mauve text-term-bg font-bold text-sm hover:opacity-90 transition-opacity"
				>
